...
$catsub_res=mysqli_query($con,"select * from sub_categories where status='1' and categories_id='62'");
$catsub_arr=array();
...
<ul>
<li>Get the software for free of cost.
</li>
<li>Get the malware free android apps.
</li>
