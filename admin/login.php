...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows($res)>0){
		...
		if($verify==1 && $row['status']=='0'){
            $msg="Account deactivated or unapproved";
        }else{ 
            ...
            <div class="login-content">
               <div class="login-form mt-150">
                  <form method="post">
					...
					<div class="field_error" style="background:#ff000038;padding:12px;border-radius:7px;"><?php echo $msg?></div>
               </div>
            </div>
         </div>
      </div>
