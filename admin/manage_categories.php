...
if(isset($_POST['submit'])){
	...
	$cat_img=$_FILES['cat_img']['name'];
				move_uploaded_file($_FILES['cat_img']['tmp_name'],PRODUCT_IMAGE_SERVER_PATH.$cat_img);
...
if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			mysqli_query($con,"update categories set categories='$categories',cat_img='$cat_img', meta_title='$meta_title', meta_desc='$meta_desc',meta_keyword='$meta_keyword' where id='$id'");
		}else{
...
values(
    '$categories','$cat_img','$meta_title','$meta_desc','$meta_keyword','1'
  )
");
		}
		header('location:categories.php');
                        ...
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Category Image</label>
